...
/*----------------------------------------*/
    $(document).ready(function () {
        ...
        $(".value-nice-select").val(selected);
    });
    $(document).ready(function () {
...
/*----------------------------------------*/
    ...
    function loadCartItems() {
        ...
        $.ajax({
            ...
            success: function (response) {
                $(".cart-itemss").html("");
                // $(".cart-itemss").html(response.output);
                $(".cart-itemss").html(response);
                // console.log(response.count);
            },
        });
    }
    ...
    $(".addToCartBtn").click(function () {
        ...
        var product_qty = $(this)
            ...
            .find(".qty-input")
            .val();
        var product_selling_price = $(this)
            .closest(".product_data")
            .find(".product_selling_price")
            .val();
        ...
        // console.log("product selling price: ", product_selling_price);
        $.ajaxSetup({
            headers: {
                "X-CSRF-TOKEN": $('meta[name="csrf-token"]').attr("content"),
            },
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                // window.location.href = "/add-on/" + product_id;
                // loadCart();
    ...
    //Add To Cartt Button page details
    $(".addToCarttBtn").click(function () {
        var product_id = $(this)
            .closest(".product_data")
            .find(".product_id")
            .val();
    ...
    //Remove Item From From wishlist
    ...
    //Increment and Decrement button for Product page Details (view.blade.php)
    $(".increment-btn").click(function () {
        ...
        var p_o_qty = $(this)
            .closest(".product_data")
            .find(".product_original_price")
            .val();
        var value = parseInt(inc_value);
        var p_o_qtyy = parseInt(p_o_qty);
        ...
        if (value < p_o_qtyy) {
            ...
            swal("There's No More Quantity In Stock !");
        }
    });
    ...
    $(".m-acc").click(function () {
        $(".ht-setting-trigger i").toggleClass("fa-chevron-up fa-chevron-down");
    });

    $(".responsive-box-sub").owlCarousel();
})(jQuery);
/*----------------------------------------------------------------------------------------------------*/
/*------------------------------------------> The End <-----------------------------------------------*/
/*----------------------------------------------------------------------------------------------------*/
