...
<div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            <li id="users" class=" nav-item"><a href="{{ route('adminDashboard')}}"><i class="la la-user"></i><span class="menu-title" data-i18n="nav.dash.main">Users</span></a>
            </li>
            <li id="restaurants" class=" nav-item"><a href="{{ route('admin.restaurants')}}"><i class="la la-user"></i><span class="menu-title" data-i18n="nav.dash.main">Restaurants</span></a>
            </li>
