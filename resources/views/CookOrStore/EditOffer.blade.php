...
<div class="app-content content">
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">Edit Offer</h3> 
                </div>
            </div>
  ...
  <form action = "{{ route('updateoffer',$offer->id)}}" method = "post" class="form-group" >    
  @csrf
  <div class="form-body"> 
      <div class="row">
      <div class="col-md-12">     
    ...
    <input type="text" class="form-control" value="{{$offer->percentage}}"  name="percentage" ><br>
    @error('percentage')
