...
<div class="app-content content">
  ...
  <form action = "{{ route('InsertFoods')}}" method = "post" class="form-group" enctype="multipart/form-data">
  @csrf
  <div class="form-body"> 
      <div class="row">
      <div class="col-md-12">   
  ...
  <div class="col-md-12">   
    ...
    <input type="text" class="form-control"  name="caloriecount" ><br>
    @error('caloriecount')
       <span class="invalid-feedback" role="alert">
       <strong>{{ $message }}</strong>
       </span>
  ...
  <div class="col-md-12">   
    ...
    <input type="text" class="form-control"  name="cuisine" ><br>
    @error('cuisine')
       <span class="invalid-feedback" role="alert">
       <strong>{{ $message }}</strong>
       </span>
  ...
  <div class="col-md-12">   
    ...
    <input type="text" class="form-control"  name="discountpercentage" ><br>
